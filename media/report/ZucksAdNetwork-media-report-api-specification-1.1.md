...
~~~sh
$ curl -s -H 'X-API-KEY: 21ba4e3r-1131-8823-81as-1lk343je218e' 'https://ms.zucksadnetwork.com/web_api/media/report/v1.1/frame/daily.csv?start=2016-07-01&end=2016-07-02'
~~~
...
~~~sh
$ curl -s -H 'X-API-KEY: ' 'https://ms.zucksadnetwork.com/web_api/media/report/v1.1/frame/daily.csv?start=2016-07-01&end=2016-07-02' -w "%{http_code}"
result
...
#### エントリポイント
~~~
https://ms.zucksadnetwork.com/web_api/media/report/v1.1/frame/daily.csv
~~~
...
~~~
$ curl -s -H 'X-API-KEY: 21ba4e3r-1131-8823-81as-1lk343je218e' 'https://ms.zucksadnetwork.com/web_api/media/report/v1.1/frame/daily.csv?start=2016-07-01&end=2016-07-02'
medium_id,medium_name,frame_id,frame_hid,frame_name,frame_page,date,imp,click,payout,cpc,ctr,ecpm
1,"メディアA",100,_12345asdfg,"メディアA_app_...","起動時レクタングル枠","2016-07-01",123456,1234,4936,4.97,0.42,20.97
1,"メディアA",100,_12345asdfg,"メディアA_app_...","起動時レクタングル枠","2016-07-02",123456,1234,4936,4.97,0.42,20.97
1,"メディアA",101,_23456sdfgh,"メディアA_app_...","起動時レクタングル枠","2016-07-01",123456,1234,4936,4.97,0.42,20.97
1,"メディアA",101,_23456sdfgh,"メディアA_app_...","起動時レクタングル枠","2016-07-02",123456,1234,4936,4.97,0.42,20.97
2,"メディアB",102,_34567dfghj,"メディアB_app_...","起動時レクタングル枠","2016-07-01",123456,1234,4936,4.97,0.42,20.97
2,"メディアB",102,_34567dfghj,"メディアB_app_...","起動時レクタングル枠","2016-07-02",123456,1234,4936,4.97,0.42,20.97
~~~
...
メディア種別が「Webサイト」の場合は、システムの制約上、`ios` がOS種別として含まれます。
