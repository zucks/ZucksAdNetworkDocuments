...
* app_store: Object. (Optional)
  ...
  * アプリ案件でも一部の広告では返却されない場合があります
    * App Storeオブジェクトを取得可能な広告のみを返却する場合は、[Request Parameter](#request-parameters)の `require_app_store` を設定してください
